...
# pluto = pidcontroller(kp=[1.5, 1.5, 3.5], kd=[3, 3, 3.5], ki=[0, 0, 0], eqb_thrust=1550)
pluto = pidcontroller(kp=[4, 4, 3], kd=[4, 4, 5], ki=[0.05, 0.05, 0.7], eqb_thrust=1550)

# pluto = pidcontroller(kp=[0, 0, 5], kd=[0, 0, 0], ki=[0, 0, 0], eqb_thrust=1550)
pluto.talker.disarm()
pluto.talker.arm()
pluto.talker.actual_takeoff()
# pluto.talker.takeoff()

pluto.autopilot([-40, -40, 80], 20)
