...
LOGFILE = os.path.join(LOG_FOLDER_PATH, f"controller/d2_{int(time.time())}.log")
...
pluto = pidcontroller(kp=[4, 4, 2.7], kd=[5, 5, 2.15], ki=[0.05, 0.05, 1.1], eqb_thrust=1550, IP=drone2_ip, PORT=PORT)
pluto.talker.disarm()
pluto.talker.arm()
